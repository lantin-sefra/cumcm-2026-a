...
\begin{longtable}{llp{6.2cm}}
  ...
  程序入口 & \verb|main.py|          & 四问求解编排与结果写出 \\
           ...
           & \verb|problem4.py|      & 问题四物质坐标求解、$2\times2$ 因子与干物质核算 \\
  ...
  计算结果 & \verb|result1.xlsx|     & 问题一温度与水分浓度全网格结果 \\
           ...
           & \verb|result3.xlsx|     & 问题三 $60\,\mathrm{s}\to t_{\rm end}$ 结果 \\
           & \verb|result4.xlsx|     & 问题四收缩域结果 \\
           & \verb|effect_isolation.csv| & Lagrangian/Eulerian $2\times2$ 时长 \\
           & \verb|shrinkage_beta.csv| & 体积收缩系数反演 \\
           & \verb|mass_consistency.csv| & 干物质守恒诊断 \\
           & \verb|sensitivity.csv|  & 单因子灵敏度记录 \\
