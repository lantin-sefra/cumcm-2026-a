...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.88\textwidth,height=0.34\textheight,keepaspectratio]{../figures/fig_q1_profiles.pdf}
  \caption{问题一温度与含水率的径向剖面}
  \label{fig:q1_profiles}
  \vspace{0.5em}
  \includegraphics[width=0.88\textwidth,height=0.34\textheight,keepaspectratio]{../figures/fig_q1_center_surface.pdf}
