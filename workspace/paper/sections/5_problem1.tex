...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.84\textwidth,height=0.30\textheight,keepaspectratio]{../figures/fig_q1_profiles.pdf}
  \caption{问题一温度与含水率的径向剖面}
  \label{fig:q1_profiles}
  \vspace{0.25em}
  \includegraphics[width=0.84\textwidth,height=0.30\textheight,keepaspectratio]{../figures/fig_q1_center_surface.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.82\textwidth,height=0.48\textheight,keepaspectratio]{../figures/fig_q1_validation.pdf}
