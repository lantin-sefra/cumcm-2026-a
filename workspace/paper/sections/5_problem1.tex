...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.78\textwidth,height=0.28\textheight,keepaspectratio]{../figures/fig_q1_profiles.pdf}
  \caption{问题一温度与含水率的径向剖面}
  \label{fig:q1_profiles}
  \vspace{0.2em}
  \includegraphics[width=0.78\textwidth,height=0.28\textheight,keepaspectratio]{../figures/fig_q1_center_surface.pdf}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.82\textwidth,height=0.42\textheight,keepaspectratio]{../figures/fig_q1_validation.pdf}
...
水分场的可信度依靠离散守恒残差与网格收敛证据支撑，详见数值可信度一章。本问的离散守恒相对残差为
$7.41\times10^{-16}$，已接近双精度浮点的机器精度。该指标用于检验有限体积离散方程的数值一致性，
不等同于真实系统总水分质量守恒误差。
