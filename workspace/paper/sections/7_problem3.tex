...
判据差别见图~\ref{fig:q3_drying_curve}，干燥速率阶段见图~\ref{fig:q3_rate_curve}。

\begin{figure}[H]
  \centering
  \includegraphics[width=0.88\textwidth,height=0.32\textheight,keepaspectratio]{../figures/fig_q3_drying_curve.pdf}
