...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.88\textwidth,height=0.34\textheight,keepaspectratio]{../figures/fig_q3_drying_curve.pdf}
  \caption{问题三干燥曲线与达标时刻定位}
  \label{fig:q3_drying_curve}
  \vspace{0.5em}
  \includegraphics[width=0.88\textwidth,height=0.34\textheight,keepaspectratio]{../figures/fig_q3_rate_curve.pdf}
