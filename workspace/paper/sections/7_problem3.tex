...
\begin{figure}[!htbp]
\centering
  \includegraphics[width=0.88\textwidth,keepaspectratio]{../figures/fig_q3_drying_curve.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.88\textwidth,keepaspectratio]{../figures/fig_q3_rate_curve.pdf}
