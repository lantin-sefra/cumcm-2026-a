...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.78\textwidth,height=0.28\textheight,keepaspectratio]{../figures/fig_q3_drying_curve.pdf}
  \caption{问题三干燥曲线与达标时刻定位}
  \label{fig:q3_drying_curve}
  \vspace{0.2em}
  \includegraphics[width=0.78\textwidth,height=0.28\textheight,keepaspectratio]{../figures/fig_q3_rate_curve.pdf}
