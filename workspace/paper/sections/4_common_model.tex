...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.78\textwidth,height=0.42\textheight,keepaspectratio]{../figures/fig_input_chamber.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.78\textwidth,height=0.42\textheight,keepaspectratio]{../figures/fig_property_maps.pdf}
