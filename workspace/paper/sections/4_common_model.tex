...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.78\textwidth,keepaspectratio]{../figures/fig_input_chamber.pdf}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.78\textwidth,keepaspectratio]{../figures/fig_property_maps.pdf}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.60\textwidth,keepaspectratio]{../figures/tikz_cylinder_cv.pdf}
