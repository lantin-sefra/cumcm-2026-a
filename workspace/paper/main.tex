...
% Linux 默认 Fandol 与 Windows 宋体行宽不同；强制正文用仓库自带 SimSun，避免页数漂移。
...
% === 页数压缩：不改字号、行距与页边距，只收紧公式/图表/节距 ===
\makeatletter
\AtBeginDocument{%
  \abovedisplayskip 6\p@ \@plus2\p@ \@minus3\p@
  \belowdisplayskip 6\p@ \@plus2\p@ \@minus3\p@
